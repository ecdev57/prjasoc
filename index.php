...
<html>
    ...
    <tbody>
      <tr  v-for='(user, index) in sortedCats '>
        ...
        <td data-label="Administration">
           <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" @click="editeruser(index, user.id)">
            Modifier
            </button>
            <button type="button" class="btn btn-danger" @click="removeElement(user.id,user.name)">Supprimer</button>
          </td>
      </tr>
    </tbody>
    <?php endfor;?>
                    ...
                    <?php for($i=0; $i<$month->getweeks(); $i ++): ?>
                        ...
                        <tr >
                            ...
                            <td>
                                ...
                                <div class="calendar__day"><?= (clone $fday)->modify("+". ($k + $i *7). "days")->format('d');?></div>
                            </td>
                            <?php endforeach;?>
                        </tr> 
                    <?php endfor;?>
